import { productsw1 , productsw2 , productsw3} from "../constants/data"
...
const responsive = {
    ...
    <Typography className={classes.type}>Mens Sandals</Typography>
    <Divider/>
          ...
          <Typography className={classes.type}>Women Scandals</Typography>
    <Divider/>
          <Carousel responsive={responsive}
          infinite={true}
          centerMode={true}
          ...
          <Typography className={classes.type}>Women Jackets</Typography>
    <Divider/>
          <Carousel responsive={responsive}
          infinite={true}
          centerMode={true}
